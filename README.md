...
Адаптивный каркас внутренней CRM/ERP на Next.js App Router. На этом этапе реализованы авторизация по email/логину и паролю, пользователи, несколько ролей, разрешения, серверный RBAC, профиль и AuditLog.
